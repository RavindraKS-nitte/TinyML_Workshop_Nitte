...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "random_forest_model"
...
#define AI_NETWORK_OUT_1_FORMAT      (AI_BUFFER_FORMAT_S32)
...
#define AI_NETWORK_OUT_2_HEIGHT      (1)
#define AI_NETWORK_OUT_2_WIDTH       (5)
#define AI_NETWORK_OUT_2_CHANNEL     (2)
#define AI_NETWORK_OUT_2_SIZE        (10)
#define AI_NETWORK_OUT_2_SIZE_BYTES  (40)
